import os
os.system("pip install py-cord python-dotenv pytz")
import pytz
import discord
...
async def on_guild_join(guild):
    ...
    embed = discord.Embed(
        ...
        description="I'm here to help you be protected from pings.",
        ...
        async for entry in message.guild.audit_logs(
            ...
            if entry.user == message.author:
                ...
                if time_diff < timedelta(minutes=5):
                    embed = discord.Embed(
                        title="Ghost Ping Detected!", color=discord.Color.red()
                    )
                    embed.add_field(
                    ...
                    embed.add_field(
                        name="Deleted on:", value=f"<t:{unix_timestamp}:R>", inline=False
                    )
